...
public class Main2Activity extends AppCompatActivity {
    ...
    private static final String TAG = "_Main2Activity";
    //url随时可能失效
//    private String url = "http://hcjs2ra2rytd8v8np1q.exp.bcevod.com/mda-hegtjx8n5e8jt9zv/mda-hegtjx8n5e8jt9zv.m3u8";
//    private String url = "http://devimages.apple.com/iphone/samples/bipbop/bipbopall.m3u8";
//    private String url = "http://qn.shytong.cn/b83137769ff6b555/11b0c9970f9a3fa0.mp4.m3u8";
    private String url = "http://devimages.apple.com/iphone/samples/bipbop/bipbopall.m3u8";
                ...
                if (curLenght - lastLength > 0) {
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            Log.e(TAG,tvSpeed1.getText().toString());
                        }
                    });
